...
tuning_model <- glmnet(x = X, y = y, alpha = 0.5, lambda = best_lambda, 
...
hist(ensemble_results_df$selection_frequency)

write.csv(ensemble_results_df, "../Models/WTM_FraminghamPACEa_TruDx_ENET_Ensemble_Model_Weights.csv")
write.csv(training_summary, "../FHS_Output/WTM_FraminghamPACEa_TruDx_ENET_Ensemble_Training_Summary.csv")
